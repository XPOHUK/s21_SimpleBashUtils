...
files = [
    'test_files/grep_file1',
    'test_files/grep_file2',
    'test_files/grep_file3',
    'test_files/grep_file4',
]
...
def run_test(command_1: str, command_2: str) -> None:
    ...
    if system(diff_command):
        ...
        if more:
            print()
            print(
                f'{bcolors.WARNING}{bcolors.BOLD}{"ARGUMENT:"}{bcolors.ENDC}{bcolors.ENDC}')
            print(command_1[len(s21_grep) + 1:-2])
            print()
            print(
                f'{bcolors.WARNING}{bcolors.BOLD}{"FLAGS:"}{bcolors.ENDC}{bcolors.ENDC}')
            for flag in _flags:
                print(flag)
            print()
            print(
                f'{bcolors.WARNING}{bcolors.BOLD}{"FILES:"}{bcolors.ENDC}{bcolors.ENDC}')
            for file in _files:
                print(file)
            print()
